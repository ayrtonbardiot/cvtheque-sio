                        ...
                        <form role="form" method="post" action="{{ route('professionnels.store') }}">
                            ...
                            <div class="mb-4">
                                <input type="text"
                                       ...
                                       placeholder="Nom du métier" aria-label="Prénom du professionnel"
                                       value="{{old('prenom')}}"/>
                                @error('prenom')
                                <p class="text-red-500" role="alert">{{ $message }}</p>
                                @enderror
                                ...
                                <div class="flex flex-col w-1/2">
                                    ...
                                    <div class="mb-4">
                                        <input type="text"
                                               ...
                                               placeholder="Nom du métier" aria-label="Code postal du professionnel"
                                               value="{{old('cp')}}"/>
                                        @error('cp')
                                        <p class="text-red-500" role="alert">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="flex flex-col w-1/2">
                                    ...
                                    <div class="mb-4">
                                        <input type="text"
                                               ...
                                               aria-label="Téléphone du professionnel" value="{{old('telephone')}}"/>
                                        @error('telephone')
                                        <p class="text-red-500" role="alert">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-4">
                                <input type="date"
                                       ...
                                       aria-label="Date de naissance du professionnel" value="{{old('naissance')}}"/>
                                @error('naissance')
                                <p class="text-red-500" role="alert">{{ $message }}</p>
                                @enderror
                            </div>
